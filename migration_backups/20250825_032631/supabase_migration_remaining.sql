-- SUPABASE DATABASE MIGRATION SCRIPT - REMAINING TABLES
-- From PascalCase to snake_case table names
-- Account was already renamed, continuing with remaining tables

BEGIN;

-- Step 1: Rename remaining PascalCase tables to snake_case
-- Skip Account (already done)
