...
// import DragDropRoleDistribution from './DragDropRoleDistribution'; // Component not in this directory
...
export default function RolesPageClient({ departments, roles }: Props) {
  ...
  return (
    <div>Component archived - DragDropRoleDistribution not available</div>
