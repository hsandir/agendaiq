...
export const { init: ___initMonitoring,
  ___captureException,
  ___captureMessage,
  setUser: ___setMonitoringusers,
  setTags: ___setMonitoringTags,
  setTag: ___setMonitoringTag,
  setContext: ___setMonitoringContext,
  ___addBreadcrumb,
  ___startTransaction,
  ___finishTransaction,
  ___captureCheckIn,
  ___startReplay,
  ___stopReplay,
  ___captureEvent,
  ___measurePerformance,
  ___withMonitoring,
  ___monitorAPICall,
  ___monitorDatabaseQuery,
  close: ___closeMonitoring,
  isInitialized: ___isMonitoringInitialized,
  getConfig: ___getMonitoringConfig,
  updateConfig: ___updateMonitoringConfig,
 } = monitoring;
