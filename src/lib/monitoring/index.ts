...
export const { init: ____initMonitoring,
  ____captureException,
  ____captureMessage,
  setUser: ____setMonitoringusers,
  setTags: ____setMonitoringTags,
  setTag: ____setMonitoringTag,
  setContext: ____setMonitoringContext,
  ____addBreadcrumb,
  ____startTransaction,
  ____finishTransaction,
  ____captureCheckIn,
  ____startReplay,
  ____stopReplay,
  ____captureEvent,
  ____measurePerformance,
  ____withMonitoring,
  ____monitorAPICall,
  ____monitorDatabaseQuery,
  close: ____closeMonitoring,
  isInitialized: ____isMonitoringInitialized,
  getConfig: ____getMonitoringConfig,
  updateConfig: ____updateMonitoringConfig,
 } = monitoring;
