...
const navigation: NavSection[] = [
  ...
  },
  {
    ...
    adminOnly: true,
    items: [
      { href: "/dashboard/system", label: "System Overview", icon: FiServer },
      { href: "/dashboard/system/health-overview", label: "System Health", icon: FiActivity },
      { href: "/dashboard/system/dependencies", label: "Dependencies", icon: FiDatabase },
      { href: "/dashboard/system/updates", label: "Package Updates", icon: FiUpload },
